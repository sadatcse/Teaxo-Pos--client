...
const OrderSummary = ({
  ...
  const [activeTab, setActiveTab] = useState('invoiceDetails'); // 'invoiceDetails' or 'customerInfo'
  ...
  return (
    <div className="w-full lg:w-2/6 p-1 md:p-6 font-inter">
      {/* Tab Navigation for Invoice Details / Customer Info */}
      <div className="bg-white rounded-2xl shadow-xl p-1 md:p-8 mb-6 border border-gray-100">
        ...
        {activeTab === 'invoiceDetails' && (
          // Invoice Details Content (formerly Order Details)
          <div className="">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  {["Cash", "Card", "Mobile"].map((method) => (
                    ...
                    >
                      ...
                      {method === "Mobile" && <MdOutlineSendToMobile />} {/* Corrected icon here */}
                      {method}
                    </button>
                  ))}
                </div>
