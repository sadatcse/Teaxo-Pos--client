                ...
                <>
                    ...
                    <section className="my-6 p-4 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow-sm rounded-lg">
                        <div className="flex flex-col md:flex-row md:items-end md:gap-3 space-y-4 md:space-y-0">
                            <div className="w-full md:flex-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        name="searchTerm"
                                        id="searchTerm"
                                        className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-805 text-slate-850 dark:text-zinc-150 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center p-2 border border-gray-300 dark:border-zinc-700 rounded-md shadow-sm text-gray-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 h-[42px] w-[42px]"
                                title="Reset Filters"
                            >
                        ...
                        <>
                            <section className="overflow-x-auto border border-gray-200 dark:border-zinc-800 shadow-sm rounded-lg p-4 bg-white dark:bg-zinc-900">
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-zinc-800">
                                    <thead className="bg-blue-600 dark:bg-zinc-800">
                                        <tr>
                                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider rounded-tl-lg">Date & Time</th>
                                    ...
                                    <tbody className="bg-white dark:bg-zinc-900 divide-y divide-gray-200 dark:divide-zinc-800">
                                        {orders.length === 0 ? (
                                            <tr>
                                                <td colSpan="6" className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-zinc-400 text-center bg-transparent">
                                                    No pending orders match the current filters.
                                                </td>
                                            </tr>
                                        ) : (
                                            orders.map((order) => (
                                                <tr key={order._id} className="hover:bg-gray-50 dark:hover:bg-zinc-850/50 transition-colors duration-200 border-b border-gray-200 dark:border-zinc-800">
                                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-zinc-300">{new Date(order.dateTime).toLocaleString()}</td>
                                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-zinc-300">{order.loginUserName}</td>
                                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-zinc-300">{order.totalAmount?.toFixed(2)} Taka</td>
                                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-zinc-300 capitalize">{order.orderType}</td>
                                                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-zinc-300">{order.tableName || order.deliveryProvider || 'N/A'}</td>
                            ...
                            {totalPages > 1 && (
                                <div className="mt-6 flex justify-between items-center px-4 py-2">
                                    <div className="text-sm text-gray-750 dark:text-zinc-300">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <button
                                            ...
                                            className="inline-flex items-center justify-center p-2 border border-gray-300 dark:border-zinc-700 rounded-md shadow-sm text-gray-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-700 disabled:bg-gray-100 dark:disabled:bg-zinc-900 disabled:cursor-not-allowed disabled:text-gray-400 dark:disabled:text-zinc-600 transition-colors"
                                            title="Previous Page"
                                        >
                    ...
                    {isModalOpen && viewOrder && (
                        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity duration-300">
                          <div className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl shadow-xl w-full max-w-3xl transform transition-all duration-300 scale-95 hover:scale-100 max-h-[90vh] flex flex-col text-slate-800 dark:text-zinc-100">
                            <div className="flex justify-between items-center p-5 border-b border-slate-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-850 rounded-t-2xl sticky top-0 z-10 flex-shrink-0">
                              <div>
                                <h2 className="text-2xl font-bold text-gray-800 dark:text-zinc-100">Order Details</h2>
                                <p className="text-sm text-gray-500 dark:text-zinc-400">Invoice ID: {viewOrder.invoiceSerial}</p>
                              </div>
                            ...
                            <div className="overflow-y-auto">
                                ...
                                <div className="p-6 space-y-6">
                                  ...
                                  <div className="flex items-center gap-3 p-3 bg-gray-100 dark:bg-zinc-800 rounded-lg">
                                    ...
                                    <div>
                                    <p className="font-semibold text-gray-700 dark:text-zinc-300">Order Date</p>
                                    <p className="text-gray-600 dark:text-zinc-405">{new Date(viewOrder.dateTime).toLocaleString()}</p>
                                    </div>
                                  </div>
                                  <div className="flex items-center gap-3 p-3 bg-gray-100 dark:bg-zinc-800 rounded-lg">
                                    <FaUserAlt className="text-green-500 flex-shrink-0" size={20} />
                                    <div>
                                    <p className="font-semibold text-gray-700 dark:text-zinc-300">Server</p>
                                    <p className="text-gray-600 dark:text-zinc-405">{viewOrder.loginUserName}</p>
                                    </div>
                                  </div>
                                  <div className="flex items-center gap-3 p-3 bg-gray-100 dark:bg-zinc-800 rounded-lg">
                                    <FaHashtag className="text-purple-500 flex-shrink-0" size={20} />
                                    <div>
                                    <p className="font-semibold text-gray-700 dark:text-zinc-300">Order Type</p>
                                    <p className="text-gray-600 dark:text-zinc-405 capitalize">{viewOrder.orderType.replace('-', ' ')}</p>
                                    </div>
                                  </div>
                                  <div className="flex items-center gap-3 p-3 bg-gray-100 dark:bg-zinc-800 rounded-lg">
                                    <FaMoneyBillWave className="text-yellow-500 flex-shrink-0" size={20} />
                                    <div>
                                    <p className="font-semibold text-gray-700 dark:text-zinc-300">Order Status</p>
                                  ...
                                  <div className="border border-slate-200 dark:border-zinc-800 rounded-lg p-4 bg-gray-50/50 dark:bg-zinc-850/30">
                                  <h4 className="font-semibold text-gray-700 dark:text-zinc-200 mb-2">Additional Info</h4>
                                  ...
                                  <div className="overflow-x-auto border border-slate-200 dark:border-zinc-800 rounded-lg">
                                    <table className="min-w-full text-sm animate-none">
                                    <thead className="bg-gray-100 dark:bg-zinc-800 text-gray-700 dark:text-zinc-300">
                                        <tr>
                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-zinc-800">
                                        ...
                                        <tr key={index} className="border-t border-slate-200 dark:border-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-850/50">
                                            <td className="p-3 text-gray-500 dark:text-zinc-400">{index + 1}</td>
                                            <td className="p-3 font-medium text-gray-800 dark:text-zinc-200">{item.productName}</td>
                                            <td className="p-3 text-center text-gray-600 dark:text-zinc-400">{item.qty}</td>
                                            <td className="p-3 text-right text-gray-600 dark:text-zinc-405">{item.rate.toFixed(2)}</td>
                                            <td className="p-3 text-right font-semibold text-gray-800 dark:text-zinc-200">{item.subtotal.toFixed(2)}</td>
                                        </tr>
                                        ))}
                                    </tbody>
                                    </table>
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div></div>
                                    <div className="text-sm border border-slate-200 dark:border-zinc-800 rounded-lg p-4 space-y-2 bg-gray-50/50 dark:bg-zinc-850/30">
                                        <div className="flex justify-between">
                                            <span className="text-gray-600 dark:text-zinc-400">Subtotal:</span>
                                            <span className="font-medium text-gray-800 dark:text-zinc-250">{viewOrder.totalSale.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600 dark:text-zinc-400">VAT (+):</span>
                                            <span className="font-medium text-gray-800 dark:text-zinc-250">{viewOrder.vat.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600 dark:text-zinc-400">Discount (-):</span>
                                            <span className="font-medium text-red-500 dark:text-red-400">{viewOrder.discount.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between text-base font-bold pt-2 border-t border-slate-200 dark:border-zinc-800 mt-2">
                                            <span className="text-gray-900 dark:text-zinc-150">Grand Total:</span>
                                            <span className="text-blue-600 dark:text-blue-450">{viewOrder.totalAmount.toFixed(2)}</span>
                                        </div>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <div className="flex-shrink-0 p-5 border-t border-slate-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-850 rounded-b-2xl flex justify-end gap-4">
                                <button
                    ...
                    {isPrintModalOpen && printData && companies[0] && (
                        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                            <div className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-xl shadow-2xl w-full max-w-sm md:max-w-md p-6 relative text-slate-805 dark:text-zinc-100 animate-none">
                                <button onClick={() => setIsPrintModalOpen(false)} className="absolute top-4 right-4 text-gray-500 hover:text-gray-800 dark:text-zinc-400 text-3xl font-bold transition-colors duration-200">&times;</button>
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-zinc-150 mb-4">Print Receipt</h2>
                                <p className="text-gray-755 dark:text-zinc-300 mb-6">Click "Print Now" to generate and print the receipt for Order ID: <span className="font-semibold">{printData.invoiceSerial}</span>.</p>
                                ...
                                <div className="flex justify-end gap-4 mt-6 pt-4 border-t border-gray-200 dark:border-zinc-800">
                                    ...
                                    <button onClick={() => setIsPrintModalOpen(false)} className="bg-gray-500 dark:bg-zinc-800 text-white dark:text-zinc-300 py-2.5 px-6 rounded-md hover:bg-gray-600 dark:hover:bg-zinc-700 transition duration-300 ease-in-out shadow-md font-semibold text-base border border-transparent dark:border-zinc-700">Close</button>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {isQrModalOpen && selectedOrderForQR && (
                        <div className="fixed inset-0 bg-black/65 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-none">
                            <div className="bg-gray-100 dark:bg-zinc-850 p-4 rounded-3xl shadow-2xl w-full max-w-xs relative text-slate-800 dark:text-zinc-100 border border-slate-200 dark:border-zinc-800">
                                <button onClick={() => setIsQrModalOpen(false)} className="absolute -top-2 -right-2 bg-white dark:bg-zinc-800 p-2 rounded-full text-red-500 hover:bg-red-100 dark:hover:bg-zinc-700 shadow-md transition-all border dark:border-zinc-700" aria-label="Close QR Code modal">
                                    <FiX size={20} />
                                </button>
